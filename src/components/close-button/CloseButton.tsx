...
// Chrome size/shape (36px square on bubble-inspired, 44px circle on this
// branch — see close-button.css) is a branch-specific look, not part of
// this component's contract. Deliberately owns chrome only, not placement:
// every current consumer fixes this to a viewport corner with its own
// responsive top/right insets tied to that modal's own layout, so
