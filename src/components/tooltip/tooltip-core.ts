...
export class TooltipController {
  ...
  private ensure(): void {
    ...
    Object.assign(bubble.style, {
      ...
      background: '#333',
      color: '#fff',
      // mobile-inspired shape fork: slightly larger radius/padding than
      // bubble-inspired's 4px/8px — matches the branch's roomier direction.
      // Positioning/animation math below is unchanged (pure behavior).
      borderRadius: '8px',
      fontSize: '14px',
      lineHeight: '1.4',
